...
public class RoomControler {
    ...
    public static boolean isHideStudentWifiStatus() {
        if (!TextUtils.isEmpty(chairmanControl) && chairmanControl.length() > 117) {
            return chairmanControl.charAt(117) == '1';
        } else {
            return false;
        }
    }
    ...
    public static boolean isOnlyAudioClassroom() {
        if (!TextUtils.isEmpty(chairmanControl) && chairmanControl.length() > 1) {
            return chairmanControl.charAt(1) == '1';
        } else {
            return false;
        }
    }
    ...
    public static boolean isSwitchAudioClassroom() {
        if (!TextUtils.isEmpty(chairmanControl) && chairmanControl.length() > 80) {
            return chairmanControl.charAt(80) == '1';
        } else {
            return false;
        }
    }
    ...
    public static boolean isHideKickPeople() {
        if (!TextUtils.isEmpty(chairmanControl) && chairmanControl.length() > 135) {
            return chairmanControl.charAt(135) == '1';
        } else {
            return false;
        }
    }
    ...
    public static boolean isChatAllowSendImage() {
        if (!TextUtils.isEmpty(chairmanControl) && chairmanControl.length() > 53) {
            return chairmanControl.charAt(53) == '1';
        } else {
            return false;
        }
    }
