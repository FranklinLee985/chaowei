...
//
+(NSData *)TK_encodeData:(NSData *)data;
...
//
+(NSData *)TK_decodeData:(NSData *)data;
...
///   A new autoreleased NSData with the encoded payload.  nil for any error.
//
+(NSData *)TK_encodeBytes:(const void *)bytes length:(NSUInteger)length;
...
///   A new autoreleased NSData with the encoded payload.  nil for any error.
//
+(NSData *)TK_decodeBytes:(const void *)bytes length:(NSUInteger)length;
...
//
+(NSString *)TK_stringByEncodingData:(NSData *)data;
...
///   A new autoreleased NSString with the encoded payload.  nil for any error.
//
+(NSString *)TK_stringByEncodingBytes:(const void *)bytes length:(NSUInteger)length;
...
///   A new autoreleased NSData with the decoded payload.  nil for any error.
//
+(NSData *)TK_decodeString:(NSString *)string;
...
///   A new autoreleased NSData with the encoded payload.  nil for any error.
//
+(NSData *)TK_webSafeEncodeData:(NSData *)data
                      padded:(BOOL)padded;
...
///   A new autoreleased NSData with the decoded payload.  nil for any error.
//
+(NSData *)TK_webSafeDecodeData:(NSData *)data;
...
///   A new autoreleased NSData with the encoded payload.  nil for any error.
//
+(NSData *)TK_webSafeEncodeBytes:(const void *)bytes
...
///   A new autoreleased NSData with the encoded payload.  nil for any error.
//
+(NSData *)TK_webSafeDecodeBytes:(const void *)bytes length:(NSUInteger)length;
...
///   A new autoreleased NSString with the encoded payload.  nil for any error.
//
+(NSString *)TK_stringByWebSafeEncodingData:(NSData *)data
                                  padded:(BOOL)padded;
...
///   A new autoreleased NSString with the encoded payload.  nil for any error.
//
+(NSString *)TK_stringByWebSafeEncodingBytes:(const void *)bytes
                                   length:(NSUInteger)length
                                   padded:(BOOL)padded;
...
///   A new autoreleased NSData with the decoded payload.  nil for any error.
//
+(NSData *)TK_webSafeDecodeString:(NSString *)string;



#pragma mark - base64
+ (NSString*)TK_md5_base64: (NSString *) inPutText;
+ (NSString*)TK_encodeBase64String:(NSString *)input;
+ (NSString*)TK_decodeBase64String:(NSString *)input;
+ (NSString*)TK_encodeBase64Data:(NSData *)data;
+ (NSString*)TK_decodeBase64Data:(NSData *)data;
